...
Summary statistics for the MLR models. Key point: including fire improves model all of the models.
```{r, echo=FALSE}
...
Started down this road... but a number of issues came up. I think a GLMM of counts as a function of environmental variation + fire (fixed) + frame (random) with a Poisson link function would be a good approach, but I need to read more to apply it appropriately. I think it is OK to proceed with making hypotheses about environemntal variables before nailing down the approach. 
...
Vapor pressure deficit is the 2nd  
