# Code by Ben Bolker for calculating r.squared for conditional model in a glmmTMB model object
# From: https://github.com/glmmTMB/glmmTMB/blob/master/glmmTMB/inst/misc/rsqglmm.R
# And: https://github.com/glmmTMB/glmmTMB/issues/169
